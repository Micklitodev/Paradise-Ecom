  ...
  return (
    ...
    <br />
      <div className="container" style={{ width: "60%" }}>
        ...
        <p>
          WARNING: Products sold on this site contain nicotine, a poisonous and
          addictive substance. Products sold on this site are only intended for
          committed smokers of legal smoking age and not by non-smokers,
          children, women who are pregnant or may become pregnant or any person
          with an elevated risk of, or preexisting condition of, any medical
          condition which includes, but is not limited to, heart disease,
          diabetes, high blood pressure or asthma. If you use a product
          purchased from us and experience any side effects or possible side
          effects, stop using the product immediately and consult a physician.
          Products sold on this site (a) may be poisonous if orally ingested,
          (b) are not smoking cessation products and have not been tested nor
          guaranteed as such, (c) have not been evaluated by the Food and Drug
          Administration, (d) are not intended to treat, prevent or cure any
          disease or condition, and (e) should be kept out of reach of children
          and pets.
        </p>
        <p>
        ...
        <h3>SECTION 8 - THIRD-PARTY LINKS AND SERVICE PROVIDERS</h3>
        <p>
        ...
        <h3>SECTION 21 - SHIPPING RESTRICTIONS</h3>
        <p>
