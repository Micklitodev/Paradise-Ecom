  ...
  return (
    <>
      ...
      >
        <h3> WARNING: </h3>
        <p>
          Products sold on this site contain nicotine, a poisonous and addictive
          substance. Products sold on this site are only intended for committed
          smokers of legal smoking age and not by non-smokers, children, women
          who are pregnant or may become pregnant or any person with an elevated
          risk of, or preexisting condition of, any medical condition which
          includes, but is not limited to, heart disease, diabetes, high blood
          pressure or asthma. If you use a product purchased from us and
          experience any side effects or possible side effects, stop using the
          product immediately and consult a physician. Products sold on this
          site (a) may be poisonous if orally ingested, (b) are not smoking
          cessation products and have not been tested nor guaranteed as such,
          (c) have not been evaluated by the Food and Drug Administration, (d)
          are not intended to treat, prevent or cure any disease or condition,
          and (e) should be kept out of reach of children and pets.
        </p>
        <br />
        <p>
          If you think someone has been exposed to an e-cigarette or liquid
          nicotine, call your local poison center at 1-800-222-1222 immediately.
        </p>
        <br />
        <p>
          CALIFORNIA PROPOSITION 65 – WARNING: This product contains nicotine, a
          chemical known to the state of California to cause birth defects or
          other reproductive harm
        </p>
        <br />
        <p>
          This website is operated by Paradise Hemp (the “Company”). Throughout
          the site, the terms "we", "us" and "our" refer to the Company. The
          Company offers this website, including all information, tools and
        ...
        <br />
        <p>
          We provide website features and other products and services to you
          when you visit or shop at our site. By visiting our site and/ or
          purchasing something from us, you engage in our "Services" and agree
        ...
        <p>
          ...
          acceptance is expressly limited to these Terms of Use. Any new
          features or tools which are added to the site shall also be subject to
          the Terms of Use. You can review the most current version of the Terms
          of Use at any time on its page. We reserve the right to update, change
          or replace any part of these Terms of Use by posting updates and/or
        ...
        <p>
          ...
          discontinue, temporarily or permanently, your use of the Services, and
          immediately in the event of technical difficulties. We will not be
          liable for any such modification, suspension or discontinuance.
        </p>
        <br />
        <p>
        ...
        <p>
          ...
          the legal smoking age in your state, city, province or country,
          whichever is older. The Services are intended solely for users who are
          at least the legal smoking age in their state, city, province or
          country, whichever is older, and any registration, use or access of
          the Services by anyone under the legal age is unauthorized,
          unlicensed, and in violation of these Terms of Use. You must be of
          legal smoking age or older to try, purchase, or use products sold on
          this site. In accordance with federal and state age verification laws,
          we use a third-party age verification system to verify users are of
          legal age, which may include collecting user photo-IDs and checking
          user identities’ against multiple databases. Once user age is
          verified, all such data is held for a period of up to 30 days and then
          destroyed.
        </p>
        <br />
        <p>
        ...
        <p>
          You must be at least the legal smoking age in your state, city,
          province or country, whichever is older, to use this site or the
          Services. We reserve the right to refuse service to anyone for any
          reason at any time.
        </p>
        <br />
        <p>
          We do not sell or market products to children, but we do sell them to
          adults of legal smoking age, who can purchase with a credit card or
          other permitted payment method. We only sell products legal under
          federal and state law. We do not sell or market products the
          possession or sale of which is illegal under either federal or state
          law. We reserve the right to refuse Services, terminate accounts,
          remove or edit content, or cancel orders in our sole discretion.
        </p>
        <br />
        <p>
          We expect you have read and fully understand these Terms of Use, which
          specifically require you to be of legal age to use this site or the
          Services or to purchase any products on this site or through the
          Services. We will not be liable or otherwise responsible to you or
          anyone else in the event you are not in fact of legal age to use this
          site or the Services or to purchase any products on this site or
          through the Services, or have otherwise circumvented or attempted to
          avoid our express age requirements contained in these Terms of Use.
          Each user is fully responsible for his or her own account and we will
          not be liable or responsible in any manner if your account is misused
          by anyone else. In addition to any other indemnification obligations
          contained elsewhere in these Terms of Use, you specifically agree to
          defend, indemnify and hold us harmless from any and all liabilities,
          obligations, claims, expenses, demands and causes of action that
          result from or arise in connection with the foregoing.
        </p>
        <br />
        <p>
          We pride ourselves on keeping electronic cigarettes and all vapor
          related products out of the hands of minors. Per the new Texas law SB
          97, all online purchasers must verify their age with a third party
          verification software. To make this easier on our customers, we have
          included this in our check out process. You will be asked for your
          driver's license/ID information as well as the last four digits of
          your social security number. This information must be processed
          through the required database and saved in your customer account. You
          will only have to complete this process once under your personal
          account. We appreciate your cooperation and assistance in keeping
          devices and accessories out of the hands of minors.
        </p>
        <br />
        <p>
        ...
        <br />
        <p>
          Subject to your compliance with these Terms of Use, we grant you a
          limited, non-exclusive, non-transferable, non-sublicensable license to
          access and make personal and non-commercial use of the Services. This
          license does not include any resale or commercial use of the Services,
          or its contents; any collection and use of any product listings,
          descriptions or prices; any derivative use of any Services or its
          ...
          similar data gathering and extraction tools. All rights not expressly
          granted to you in these Terms of Use are reserved and retained by us.
          You agree not to reproduce, duplicate, copy, sell, resell or exploit
          any portion of the Services, use of the Service, or access to the
          Services or any contact on the website through which the Service is
          provided, without express written permission by us. You may not frame
          ...
          of ours without express written consent. You may not use any meta tags
          or any other "hidden text" utilizing our name or trademarks without
          our express written consent. You may not misuse the Services. You may
          use the Services only as permitted by law. The licenses granted by us
          terminate if you do not comply with these Terms of Use.
        </p>
        <br />
        <p>
          All content included in or made available through the Services, such
          as text, graphics, logos, button icons, images, audio clips, digital
          downloads, and data compilations is our property or our content
          ...
          through the Services is our exclusive property and protected by U.S.
          and international copyright laws.
        </p>
        <br />
        <p>
          The graphics, logos, page headers, button icons, scripts, and service
          names included in or made available through the Services are
          trademarks or trade dress. Our trademarks and trade dress may not be
          used in connection with any product or service that is not ours, in
          any manner that is likely to cause confusion among customers, or in
          any manner that disparages or discredits us. All other trademarks not
          owned by us that appear in or made available through the Services are
        ...
        <p>
          ...
          your expectations, or that any errors in the Services will be
          corrected.
        </p>
        <br />
        ...
        <p>
          ...
          account information for all purchases. You agree to promptly update
          your account and other information, including your email address and
          credit card numbers and expiration dates, so that we can complete your
          transactions and contact you as needed. You acknowledge and agree such
          information, including your credit card numbers, may be stored by us
          and our third-party service providers pursuant to the terms of our
          Privacy Policy.
        </p>
        <br />
        ...
        <br />
        <h3>SECTION 8 - THIRD-PARTY LINKS AND SERVICE PROVIDERS</h3> <br />
        <p>
        ...
        <br />
        <p>
          We use third-party service providers to help sell our products and
          Services to you. Among other things, such third-party service
          providers may collect, use, and disclose your information, but only to
          the extent necessary to allow them to perform the services they
          provide us. For more information, please review our Privacy Policy. We
          are not liable for any harm or damages caused by or related to such
          third-party service providers’ collection, storage, use, or disclosure
          of your information. We recommend that you read their privacy policies
        ...
        <p>
          ...
          rights to the comments that you post; that the comments are accurate;
          that use of the comments you supply does not violate these Terms of
          Use and will not cause injury to any person or entity; and that you
          will indemnify us for all claims resulting from comments you supply.
          We have the right but not the obligation to monitor and edit or remove
          any activity or comments. We take no responsibility and assume no
        ...
        <p>
          ...
          ACCURACY OR RELIABILITY OF ANY USER COMMENTS OR ENDORSE ANY OPINIONS
          EXPRESSED BY USERS. YOU ACKNOWLEDGE THAT ANY RELIANCE ON COMMENTS
          POSTED BY OTHER USERS WILL BE AT YOUR SOLE RISK.
        </p>{" "}
        <br />
        <h3>SECTION 10 - PERSONAL INFORMATION</h3> <br />
        <p>
          Your submission of personal information through the store is governed
          by our Privacy Policy. To view our Privacy Policy Click Here.
        </p>{" "}
        <br />
        <h3>SECTION 11 - ERRORS, INACCURACIES AND OMISSIONS</h3> <br />
        <p>
        ...
        <p>
          ...
          refresh date applied in the Services or on any related website should
          be taken to indicate that all information in the Services or on any
          related website has been modified or updated.
        </p>{" "}
        <br />
        <h3>SECTION 12 - PROHIBITED USES</h3> <br />
        <p>
        ...
        <ul style={{ fontSize: 13 }}>
          ...
          <li>
            ...
            functionality or operation of the Services or of any related
          ...
          <li>
            ...
            Services or any related website, other websites, or the Internet. We
            reserve the right to terminate your use of the Services or any
        ...
        <p>
          ...
          THE SITE ARE PROVIDED BY US ON AN "AS IS" AND "AS AVAILABLE" BASIS. WE
          MAKE NO REPRESENTATIONS OR WARRANTIES OF ANY KIND, EXPRESS OR IMPLIED,
          AS TO THE OPERATION OF THE SERVICES, OR THE INFORMATION, CONTENT,
          MATERIALS, PRODUCTS, OR OTHER SERVICES INCLUDED ON OR OTHERWISE MADE
          AVAILABLE TO YOU THROUGH THE SITE. YOU EXPRESSLY AGREE THAT YOUR USE
        ...
        <p>
          ...
          DO NOT WARRANT THAT THE SERVICES, INFORMATION, CONTENT, MATERIALS,
          PRODUCTS, OR OTHER SERVICES INCLUDED ON OR OTHERWISE MADE AVAILABLE TO
          YOU THROUGH THE SITE, OUR SERVERS, OR ELECTRONIC COMMUNICATIONS SENT
          FROM US ARE FREE OF VIRUSES OR OTHER HARMFUL COMPONENTS. THIS
          DISCLAIMER APPLIES TO ANY DAMAGES OR INJURY CAUSED BY ANY FAILURE OF
          PERFORMANCE, ERROR, OMISSION, INTERRUPTION, DELETION, DEFECT, DELAY IN
          OPERATION OR TRANSMISSION, COMPUTER VIRUS OR ANY FORM OF MALICIOUS
          CODE, COMMUNICATION LINE FAILURE, THEFT, OR DESTRUCTION OR
          UNAUTHORIZED ACCESS TO, ALTERATION OF, OR USE OF RECORDS. YOU
          SPECIFICALLY ACKNOWLEDGE THAT WE ARE NOT LIABLE FOR THE DEFAMATORY,
          OFFENSIVE, OR ILLEGAL CONDUCT OF OTHER USERS OR THIRD PARTIES AND THAT
          THE RISK OF INJURY FROM THE FOREGOING RESTS ENTIRELY WITH YOU. WE WILL
          NOT BE LIABLE FOR ANY DAMAGES OF ANY KIND ARISING FROM THE USE OF THE
          SERVICES, OR FROM ANY INFORMATION, CONTENT, MATERIALS, PRODUCTS, OR
          OTHER SERVICES INCLUDED ON OR OTHERWISE MADE AVAILABLE TO YOU THROUGH
          THE SITE, INCLUDING, BUT NOT LIMITED TO, DIRECT, INDIRECT, PUNITIVE,
          INCIDENTAL, SPECIAL, OR CONSEQUENTIAL DAMAGES, WHETHER BASED ON
          CONTRACT, TORT, STRICT LIABILITY, OR OTHERWISE, EVEN IF WE HAVE BEEN
          ADVISED OF THE POSSIBILITY OF SUCH DAMAGES. IF YOU ARE DISSATISFIED
          WITH ANY PORTION OF THE SERVICES, YOUR SOLE AND EXCLUSIVE REMEDY IS TO
        ...
        <p>
          ...
          Services will be accurate or reliable. You agree that from time to
          time we may remove the Services for indefinite periods of time or
        ...
        <br />
        <p>
          In no case shall eCig Distributors, Inc., our directors, officers,
        ...
        <br />
        <h3>SECTION 14 - INDEMNIFICATION</h3> <br />
        <p>
          You agree to indemnify, defend, and hold harmless eCig Distributors,
          ...
          third-party due to or arising out of your use of the Services or by
          your breach of these Terms of Use or the documents they incorporate by
          reference, or your violation of any law or the rights of a
          third-party.
        </p>{" "}
        <br />
        <h3>SECTION 15 - SEVERABILITY</h3> <br />
        <p>
        ...
        <br />
        <h3>SECTION 16 - TERMINATION</h3> <br />
        <p>
        ...
        <br />
        <h3>SECTION 17 - ENTIRE AGREEMENT</h3> <br />
        <p>
          ...
          posted by us on this site or in respect to the Services constitute the
        ...
        <br />
        <h3>SECTION 18 - GOVERNING LAW</h3> <br />
        <p>
          ...
          laws of Nevada, without regard to principles of conflicts of laws.
        </p>{" "}
        <br />
        <h3>SECTION 19 - CHANGES TO TERMS OF USE</h3> <br />
        <p>
        ...
        <p>
          ...
          website or the Services following the posting of any changes to these
          Terms of Use constitutes acceptance of those changes.
        </p>{" "}
        <br />
        <h3>SECTION 20 - CONTACT INFORMATION</h3> <br />
        <p>
          Questions about the Terms of Use should be sent to us at
          support@ejuices.com.
        </p>{" "}
        <br />
        <h3>SECTION 21 - SHIPPING RESTRICTIONS</h3> <br />
        <p>
          Some products can’t be shipped to all geographical locations due to
          warranty issues, manufacturer requirements, legal, and other
          restrictions. You’ll be notified when placing your order if we’re
          unable to ship specific items to the address you’ve indicated. Please
          also check the product detail pages for any item-specific shipping
          restrictions. We reserve the right to cancel any shipment, in its sole
          discretion, and issue a full refund.
        </p>{" "}
        <br />
        <h3>SECTION 22 – RISK OF LOSS</h3> <br />
        <p>
          ...
          upon delivery to the carrier. We are not responsible for items lost in
          transit, items sent to the wrong address, products seized by customs
          or governmental agencies, nor international fees charged by your
          country or third parties.
        </p>{" "}
        <br />
        <h3>SECTION 23 - DISPUTES</h3> <br />
        <p>
          Any dispute or claim (excluding any that you may assert in small
          claims court if your claims qualify) relating in any way to your use
          of the Services, or to any products or services sold or marketed by us
          or through the site will be resolved by binding arbitration, rather
          than in court, in Clark County, Nevada, administered by JAMS pursuant
          to its Comprehensive Arbitration Rules and Procedures. The Federal
        ...
        <p>
          ...
          follow the terms of these Terms of Use as a court would.
        </p>{" "}
        <br />
        <p>
          ...
          court to enjoin infringement or other misuse of intellectual property
          rights.
        </p>{" "}
        <br />
      </div>
